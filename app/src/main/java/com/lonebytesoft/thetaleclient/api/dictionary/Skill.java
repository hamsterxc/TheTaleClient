...
public enum Skill {
    ...
    WARRIOR("Воин", "Воин большую часть времени тратит на физические тренировки, благодаря чему наносит больший физический урон, имеет хорошую защиту от физических атак, но слабо противостоит магии и сам с трудом ей пользуется.", 5, SkillType.COMBAT, SkillAvailability.ALL, SkillMethod.PASSIVE, false),
    ...
    MAGE("Маг", "Маг всё своё усердие направляет в совершенствование магических умений, поэтому имеет увеличенный магический урон, защиту от магии и уменьшенные физический урон и защиту от физических атак.", 5, SkillType.COMBAT, SkillAvailability.ALL, SkillMethod.PASSIVE, false),
    ...
    private final SkillMethod method;
    private final boolean isDirectDamage;
