...
public enum CompanionFeature {
    ...
    PIGMEAT("не жилец", "при ранении может получить большой дополнительный урон", CompanionFeatureType.PERSISTENT),
    ...
    PUNY("тщедушный", "при ранении может получить дополнительный урон", CompanionFeatureType.PERSISTENT),
    ...
    public final CompanionFeatureType type;
